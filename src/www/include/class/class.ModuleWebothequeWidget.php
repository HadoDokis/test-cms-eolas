...
class ModuleWebothequeWidget extends ModuleWebotheque
{
    /**
    ...
    public function delete(Site $oSite)
    {
        ...
        require_once CLASS_DIR . 'class.db_webothequeCategorie.php';
        WebothequeCategorie::clearCategorie('WBT_WIDGET', $oSite->getField('SIT_CODE'));
