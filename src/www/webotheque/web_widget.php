...
$oWebotheque = new Webo_WIDGET($_GET['idtf']);
...
<body>
<div id="document">
   <?php $aMenuKey = array('WEB', 'MOD_WEBOTHEQUE_WIDGET', 'WIDGET'); if (!$oWebotheque->exist()) $aMenuKey[]='ADD'; include('../include/inc.bo_bandeau_haut.php') ?>
    <div id="corps">
        <div id="bo_contenu">
            <h2><?php echo $oWebotheque->exist() ? secureInput($row['WEB_LIBELLE']) : 'Nouveau widget' ?></h2>
