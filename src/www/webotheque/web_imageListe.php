...
<body>
<div id="document">
    <?php $aMenuKey = array('WEB', 'MOD_WEBOTHEQUE_IMAGE', 'IMAGE', 'LISTE'); include('../include/inc.bo_bandeau_haut.php') ?>
    <div id="corps">
        <div id="bo_contenu">
                ...
                <table class="liste">
                    ...
                    foreach ($p->fetch($sql, 'WEBOTHEQUE.ID_WEBOTHEQUE') as $rowListe) {
                        ...
                        <tr>
                            ...
                            <td><a href="web_image.php?idtf=<?php echo $rowListe['ID_WEBOTHEQUE']?>"><?php echo secureInput($rowListe['WEB_LIBELLE'])?></a></td>
                            <td class="alignright"><?php echo File_management::displayFileSize($rowListe['WEB_TAILLE']) ?></td>
                            <td class="aligncenter"><a href="<?php echo $oWebo->getSRC()?>" class="lightbox" rel="webotheque"><img src="<?php echo $oWebo->getThumbSRC()?>" alt=""></a></td>
