...
<body>
<div id="document">
    <?php $aMenuKey = array('WEB', 'MOD_WEBOTHEQUE_VIDEO', 'VIDEO', 'LISTE'); include('../include/inc.bo_bandeau_haut.php') ?>
    <div id="corps">
        <div id="bo_contenu">
            <h2><?php echo gettext('Videos')?></h2>
            ...
            <form method="post" action="web_webothequeSubmit.php">
                <table class="liste">
                    ...
                    foreach ($p->fetch($sql, 'WEBOTHEQUE.ID_WEBOTHEQUE') as $rowListe) {
                        $oWebo = new Webo_VIDEO($rowListe['ID_WEBOTHEQUE']);
                        ...
                        <tr>
                            ...
                            <td><a href="web_video.php?idtf=<?php echo $rowListe['ID_WEBOTHEQUE']?>"><?php echo secureInput($rowListe['WEB_LIBELLE'])?></a></td>
