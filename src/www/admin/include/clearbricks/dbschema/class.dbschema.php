<?php
/*
 * Classe permetant de manipuler le schéma particulier d'une base de données
...
interface i_dbSchema
{
	...
	*/
	...
	function db_create_field($table,$name,$type,$len,$attr,$null,$default,$extra,$after);
	...
	function db_alter_field($table,$name,$type,$len,$attr,$null,$default,$extra,$after);
	...
	function db_drop_field($table, $name);
	
	function db_drop_reference($table, $name);
...
class dbSchema
{
	...
	*/
	...
	public function createField($table,$name,$type,$len,$attr,$null,$default,$extra=null,$after=null)
	{
		return $this->db_create_field($table,$name,$type,$len,$attr,$null,$default,$extra,$after);
	}
	...
	public function alterField($table,$name,$type,$len,$attr,$null,$default,$extra=null,$after=null)
	{
		return $this->db_alter_field($table,$name,$type,$len,$attr,$null,$default,$extra,$after);
	}
	...
	public function alterReference($name,$newname,$c_table,$c_cols,$p_table,$p_cols,$update=false,$delete=false)
	{
	...
	{
		return $this->db_drop_table($table);
	}
	public function dropField($table,$name)
	{
		return $this->db_drop_field($table, $name);
	}
	public function dropReference($table,$name)
	{
		return $this->db_drop_reference($table,$name);
	}
	public function dropIndex($table,$name)
	{
		return $this->db_drop_index($table,$name);
	}
    public function dropPrimary($table,$name)
    {
        return $this->db_drop_primary($table,$name);
    }
